/*
 * Copyright (C) 2009-2014 eXo Platform SAS.
 *
...
public abstract class AbstractResourceTest extends AbstractServiceTest {
   ...
   * @throws Exception
   */
  public ContainerResponse performTestCase(String methodType, String fullPath, String path) throws Exception {
    MultivaluedMap<String, String> h = new MultivaluedMapImpl();
    ByteArrayContainerResponseWriter writer = new ByteArrayContainerResponseWriter();
    ContainerResponse response = service(methodType, fullPath + path, "", h, null, writer);
    return response;
  }
